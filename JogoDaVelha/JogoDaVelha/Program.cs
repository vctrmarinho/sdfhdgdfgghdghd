...
namespace JogoDaVelha
{
    internal class Program
    {
        ...
        static void coletaPosicao(string play1, string play2)
        {
            ...
            if (verificaCampoInvalido() == true)
            {
                Console.WriteLine("O campo escolhido não pode ser jogado duas vezes!");
            }
        ...
        static bool verificaCampoInvalido()
        {
            bool campo = false;

            if (P1 == 'X' || P1 == 'O' || P2 == 'X' || P2 == 'O' || P3 == 'X' || P3 == 'O' || P4 == 'X' || P4 == 'O' ||
                P5 == 'X' || P5 == 'O' || P6 == 'X' || P6 == 'O' || P7 == 'X' || P7 == 'O' ||
                P8 == 'X' || P8 == 'O' || P9 == 'X' || P9 == 'O')
            {
                campo = true;
            }
